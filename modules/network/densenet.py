...
class Generator(BaseNetwork):
    def __init__(self, z_dim, input_size: tuple = (3, 32, 32), **kwargs):
    ...
    def forward(self, z):
        ...
        output = output.view(z.shape[0], 3, *self.feature_dim[0])
...
class Critic(BaseNetwork):
    def __init__(self, ndf, z_dim, critic_dim, input_size: tuple = (3, 32, 32), **kwargs):
        ...
        self.fc = nn.Linear(in_planes, self.critic_dim)
