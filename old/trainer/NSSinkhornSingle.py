...
class NSSinkhornSingle(UpdaterBase):

    def __init__(self, params, network, pre_train=None):
        super(NSSinkhornSingle, self).__init__(params, network, pre_train)
    ...
    def update_parameters_discriminator(self, z, x, y):
        ...
        loss_real_realv = self.sinkhorn_loss(d_real, d_real)[0]
        loss_fake_fakev = self.sinkhorn_loss(d_fake, d_fake)[0]
